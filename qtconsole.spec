...
%prep
%setup -q -n qtconsole-5.0.1
cd %{_builddir}/qtconsole-5.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606260213
...
cp %{_builddir}/qtconsole-5.0.1/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
