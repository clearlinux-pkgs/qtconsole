...
Source0  : https://files.pythonhosted.org/packages/f3/25/b0ec7d11ae01ecc06a29bfa093f32dfd54ed5047f4946c84b23863dfe0d3/qtconsole-4.6.0.tar.gz
...
%prep
%setup -q -n qtconsole-4.6.0
cd %{_builddir}/qtconsole-4.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574049401
...
cp %{_builddir}/qtconsole-4.6.0/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
