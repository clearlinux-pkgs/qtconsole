...
Source0  : https://files.pythonhosted.org/packages/87/c4/5b5cfe345486c6d349877131008c7df0b9fae91a5d209db3258670757a95/qtconsole-5.2.1.tar.gz
...
%prep
%setup -q -n qtconsole-5.2.1
cd %{_builddir}/qtconsole-5.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637692509
...
cp %{_builddir}/qtconsole-5.2.1/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
