...
Source0  : https://files.pythonhosted.org/packages/24/11/b9603e8ae56107789d7ef21ea937675623986bdf3e9a8b195f146782343d/qtconsole-5.0.3.tar.gz
...
%prep
%setup -q -n qtconsole-5.0.3
cd %{_builddir}/qtconsole-5.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615993252
...
cp %{_builddir}/qtconsole-5.0.3/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
