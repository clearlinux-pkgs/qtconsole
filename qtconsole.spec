...
Source0  : https://files.pythonhosted.org/packages/ad/b3/ab55daf98adbab13cfe413140a73e7e69819f3e3d2576c81c7899d5876a6/qtconsole-4.7.5.tar.gz
...
%prep
%setup -q -n qtconsole-4.7.5
cd %{_builddir}/qtconsole-4.7.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592867836
...
cp %{_builddir}/qtconsole-4.7.5/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
