...
Version  : 5.0.0
Release  : 49
URL      : https://files.pythonhosted.org/packages/fb/ef/6cf8a7301726a7b7149e95102c70f809542dfcd916826e8dccc0d90b2605/qtconsole-5.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/fb/ef/6cf8a7301726a7b7149e95102c70f809542dfcd916826e8dccc0d90b2605/qtconsole-5.0.0.tar.gz
...
%prep
%setup -q -n qtconsole-5.0.0
cd %{_builddir}/qtconsole-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606236748
...
cp %{_builddir}/qtconsole-5.0.0/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
