...
%prep
%setup -q -n qtconsole-4.7.0
cd %{_builddir}/qtconsole-4.7.0
...
cp %{_builddir}/qtconsole-4.7.0/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
