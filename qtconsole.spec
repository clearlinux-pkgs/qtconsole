...
%prep
%setup -q -n qtconsole-4.7.7
cd %{_builddir}/qtconsole-4.7.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599158620
...
cp %{_builddir}/qtconsole-4.7.7/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
