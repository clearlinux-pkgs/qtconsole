...
Source0  : https://files.pythonhosted.org/packages/e1/e0/e97cc3072767c84b4bd4dc9e5291e3853749e4237223f85b620dfd311f1a/qtconsole-5.0.2.tar.gz
...
%prep
%setup -q -n qtconsole-5.0.2
cd %{_builddir}/qtconsole-5.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611275706
...
cp %{_builddir}/qtconsole-5.0.2/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
