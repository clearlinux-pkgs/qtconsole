...
Source0  : https://files.pythonhosted.org/packages/c1/a4/9ad9ff7e90f0dfe8dfee161c96cf334693cb14ca9f861f89cfc751c74154/qtconsole-5.1.0.tar.gz
...
%prep
%setup -q -n qtconsole-5.1.0
cd %{_builddir}/qtconsole-5.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619998781
...
cp %{_builddir}/qtconsole-5.1.0/LICENSE %{buildroot}/usr/share/package-licenses/qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
